...
public class LocationController {
    ...
    public ResponseEntity<?> createLocation(@Valid @RequestBody LocationDTO location) {
        ...
        return GlobalExceptionHandler.GoodResponse(HttpStatus.CREATED, "Location created successfully", saved);
    }
    ...
    public ResponseEntity<?> updateLocation(@PathVariable Long id,
        ...
        LocationResponseDTO updated = locationService.updateLocation(id, updatedLocation);
    ...
    public ResponseEntity<?> getAllByAdmin() {
        List<LocationResponseDTO> locations = locationService.getAllLocationsByAdmin();
